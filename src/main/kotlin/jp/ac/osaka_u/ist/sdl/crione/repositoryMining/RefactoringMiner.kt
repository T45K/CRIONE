...
fun mining(repository: Repository, trackingTargetBranch: String = "master"): List<String> {
    ...
    miner.detectAll(repository, trackingTargetBranch, object : RefactoringHandler() {
