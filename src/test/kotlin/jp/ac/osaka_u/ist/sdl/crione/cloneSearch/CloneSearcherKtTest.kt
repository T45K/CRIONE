...
class CloneSearcherKtTest {
    ...
    fun testSearch() {
        ...
        assertEquals("sample/cloneSearch/File1.java", filePath0)
        ...
        assertEquals("sample/cloneSearch/File1.java", filePath1)
        ...
        assertEquals("sample/cloneSearch/File2.java", filePath2)
